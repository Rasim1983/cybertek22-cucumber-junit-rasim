...
public class ExcelRead {
    ...
    public void read_from_excel_file() throws IOException {
        ...
        //TO be able to read fro Excel file, we need load it into FileInputStream
        ...
        //Returns the number of top cell to bottom cell
        //It does not care if there ara empty cells or not
        ...
        for (int rowNum = 0; rowNum < usedRows; rowNum++) {
            if (sheet.getRow(rowNum).getCell(0).toString().equals("Rasim")) {
